#Sys-Fxp47 - IndoSecDown
#TIDAK DI PERJUAL BELIKAN
#Want To Recode? Chat Author
...
if __name__ == "__main__":
        try:
                ...
                banner = f'''
{rdm} __  __ ___ ___
{rdm}|  \/  | _ )_ _| {W + B}| Author  : Sys - Fxp47
{rdm}| |\/| | _ \| |  {W + B}| Contact : +62 812-4489-6793
{rdm}|_|  |_|___/___| {W + B}| Resiko Tanggung Sendiri - {R + D}Sys-{W + B}Fxp47{C}
                '''
                print(banner)
